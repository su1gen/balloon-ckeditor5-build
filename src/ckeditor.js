...
class CollaborationBalloonEditor extends BalloonEditorBase {}
class DefaultBalloonEditor extends BalloonEditorBase {}

// Plugins to include in the build.

CollaborationBalloonEditor.builtinPlugins = [
	Task,
	ToggleList,
	DoubleColumns,
	Essentials,
...
CollaborationBalloonEditor.defaultConfig = {
	blockToolbar: [
		'heading',
		'|',
		'task',
...
export default { CollaborationBalloonEditor, DefaultBalloonEditor, EditorWatchdog };
